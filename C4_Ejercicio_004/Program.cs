using C4_Entidades_4;
using System;

namespace C4_Ejercicio_004
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (estante - p2)
            {
                Console.WriteLine("Quitó {0} {1} {2}", p2.Marca, (string)p2, p2.Precio);
            }
            else
            {
                Console.WriteLine("¡NO quitó {0} {1} {2}!", p2.Marca, (string)p2, p2.Precio);
            }
